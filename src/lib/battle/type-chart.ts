// Full 18x18 type effectiveness chart (Gen VI+ rules)
// Only non-1.0 multipliers are listed; absent = 1.0 (normal damage)
...
/**
 * Returns the type effectiveness multiplier for a move type vs defender types.
 * e.g. getEffectiveness("electric", ["water", "flying"]) => 4 (super effective x2)
 */
